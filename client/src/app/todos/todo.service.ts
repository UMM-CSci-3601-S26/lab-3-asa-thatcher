...
export class TodoService {
   ...
   *
   * @param filters a map that allows us to specify a target owner, category,
   *  body, or status to filter by, or any combination of those
   ...
   */
  getTodos(filters?: { owner?: string; category?: string; body?: string; status?: string; limit?: number}): Observable<Todo[]> {
